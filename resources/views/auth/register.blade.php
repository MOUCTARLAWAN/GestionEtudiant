   ...
   <div class="container">
        <div class="row">
           <div class="col-md-5 mx-auto">
            <h1 class="text-center text-muted mb-3 mt-5">Inscription</h1>
            <p class="text-center text-muted mb-3 mt-5"> Creer un compte si vous avez pas de compte.</p>
            <form method="POST" action="{{route('register')}} " class="row g-3" id="form-register" >
                ...
                <div class="col-md-6">
                 ...
                 <div class="d-grid gap-2">
                    <button class="btn btn-primary" type="button" id="register-user">Inscription</button>
                  </div>

                  <p class="text-center text-muted mt-5"> <a href="{{route('login')}}">Se connecter</a></p>
